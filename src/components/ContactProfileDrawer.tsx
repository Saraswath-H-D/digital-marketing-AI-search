...
export default function ContactProfileDrawer({
  ...
  const getIntentBadge = () => {
    ...
    return (
      <span className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-full text-2xs font-extrabold bg-slate-100 text-slate-600 border border-slate-200">
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-slate-900/60 backdrop-blur-xs flex justify-end animate-fadeIn">
      <div 
        className="relative w-full max-w-2xl bg-white shadow-2xl h-full flex flex-col transform transition-transform duration-300 ease-in-out border-l border-slate-200 overflow-hidden"
      ...
      >
        ...
        <div className="p-6 bg-gradient-to-b from-indigo-50/40 via-white to-white border-b border-slate-150">
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 text-white font-extrabold text-2xl flex items-center justify-center shadow-lg shadow-indigo-200 ring-4 ring-white">
                  {initials}
                </div>
              ...
              <div>
                <div className="flex items-center space-x-2.5">
                  ...
                  <button 
                    ...
                    className={`p-1.5 rounded-lg transition-colors cursor-pointer ${
                      lead.isSaved ? 'text-amber-500 bg-amber-50' : 'text-slate-400 hover:bg-slate-100'
                    }`}
                ...
                <div className="flex flex-wrap items-center gap-y-1 gap-x-3 text-xs font-semibold text-slate-600 mt-1">
                  {lead.jobTitle && (
            ...
            <button
              onClick={() => onEdit(lead)}
              className="inline-flex items-center space-x-1.5 px-3 py-1.5 text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-2xs cursor-pointer"
            >
        ...
        {/* Tab Navigation */}
        <div className="flex items-center px-6 bg-slate-50/80 border-b border-slate-200 space-x-1 shrink-0 overflow-x-auto scrollbar-none">
          {[
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-thin space-y-6">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-slate-50/70 border border-slate-200/80 rounded-2xl p-4.5 space-y-4">
                <h3 className="text-xs font-extrabold uppercase tracking-wider text-slate-700 flex items-center justify-between">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div className="space-y-1">
                    <span className="text-3xs font-bold text-slate-400 uppercase tracking-wider block">Email Address</span>
                    <div className="flex items-center justify-between bg-white border border-slate-200 rounded-xl px-3 py-2">
                      <span className="font-semibold text-slate-800 truncate">{lead.email || '-'}</span>
                  ...
                  <div className="space-y-1">
                    <span className="text-3xs font-bold text-slate-400 uppercase tracking-wider block">Direct Phone</span>
                    <div className="flex items-center justify-between bg-white border border-slate-200 rounded-xl px-3 py-2">
                  ...
                  <div className="space-y-1">
                    <span className="text-3xs font-bold text-slate-400 uppercase tracking-wider block">Seniority Level</span>
                    <div className="bg-white border border-slate-200 rounded-xl px-3 py-2 font-semibold text-slate-800">
                  ...
                  <div className="space-y-1">
                    <span className="text-3xs font-bold text-slate-400 uppercase tracking-wider block">Industry</span>
                    <div className="bg-white border border-slate-200 rounded-xl px-3 py-2 font-semibold text-slate-800">
          ...
          {activeTab === 'activity' && (
            <div className="space-y-4 animate-fadeIn">
              <h3 className="text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">Audit & Interaction Timeline</h3>
              ...
              <div className="space-y-3 relative pl-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
                <div className="relative flex items-start space-x-3 bg-white p-3.5 border border-slate-200 rounded-xl shadow-2xs">
                  <div className="absolute -left-6 top-4 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-white ring-2 ring-emerald-100" />
                  <div>
                    <span className="text-xs font-bold text-slate-800 block">Lead Synced to PostgreSQL Database</span>
                    <span className="text-3xs text-slate-400 block mt-0.5">{lead.createdAt || 'Just now'} • Verified Table Sync</span>
                  </div>
                </div>

                <div className="relative flex items-start space-x-3 bg-white p-3.5 border border-slate-200 rounded-xl shadow-2xs">
                  <div className="absolute -left-6 top-4 w-3.5 h-3.5 rounded-full bg-indigo-500 border-2 border-white ring-2 ring-indigo-100" />
                  <div>
                    <span className="text-xs font-bold text-slate-800 block">AI Intent & Match Score Computed (92/100)</span>
                    <span className="text-3xs text-slate-400 block mt-0.5">High Intent buying signals detected from SaaS company growth</span>
                  </div>
                </div>

                <div className="relative flex items-start space-x-3 bg-white p-3.5 border border-slate-200 rounded-xl shadow-2xs">
                  <div className="absolute -left-6 top-4 w-3.5 h-3.5 rounded-full bg-purple-500 border-2 border-white ring-2 ring-purple-100" />
                  <div>
                    <span className="text-xs font-bold text-slate-800 block">Contact Created via #{lead.sourceName || 'CSV Upload'}</span>
                    <span className="text-3xs text-slate-400 block mt-0.5">{lead.registrationTime || 'Today'}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'emails' && (
            <div className="space-y-4 animate-fadeIn">
              <div className="flex items-center justify-between">
                <h3 className="text-xs font-extrabold text-slate-700 uppercase tracking-wider">AI Sales Pitch Generator</h3>
              ...
              <div className="space-y-3 bg-slate-50 border border-slate-200 p-4 rounded-2xl">
                <div>
                  <label className="text-3xs font-bold text-slate-500 uppercase tracking-wider block mb-1">Subject Line</label>
                  <input
                    type="text"
                    value={aiDraftSubject}
                    onChange={(e) => setAiDraftSubject(e.target.value)}
                    className="w-full text-xs font-bold px-3 py-2 border border-slate-200 rounded-xl bg-white focus:outline-none focus:border-indigo-500"
                  />
                </div>

                <div>
                  <label className="text-3xs font-bold text-slate-500 uppercase tracking-wider block mb-1">Email Body</label>
                  <textarea
                    rows={6}
                    value={aiDraftBody}
                    onChange={(e) => setAiDraftBody(e.target.value)}
                    className="w-full text-xs font-medium px-3 py-2 border border-slate-200 rounded-xl bg-white focus:outline-none focus:border-indigo-500 leading-relaxed"
                  />
                </div>
                ...
                <div className="flex items-center justify-end space-x-2 pt-1">
                  <button
                    ...
                    className="inline-flex items-center space-x-1 px-3 py-1.5 text-xs font-bold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-100 cursor-pointer"
                  >
          ...
          {activeTab === 'notes' && (
            <div className="space-y-3 animate-fadeIn">
              <div className="flex items-center justify-between">
                <h3 className="text-xs font-extrabold text-slate-700 uppercase tracking-wider">Internal Team Notes</h3>
              ...
              <textarea
                ...
                className="w-full text-xs font-medium p-4 border border-slate-200 rounded-2xl bg-slate-50/50 focus:bg-white focus:outline-none focus:border-indigo-500"
              />
            ...
            <div className="space-y-4 animate-fadeIn">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                  <span className="text-3xs font-bold text-slate-400 uppercase block mb-0.5">Estimated Revenue</span>
                  <span className="font-extrabold text-slate-800">$25M – $50M</span>
                </div>
                <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl">
                  <span className="text-3xs font-bold text-slate-400 uppercase block mb-0.5">Funding Round</span>
                  <span className="font-extrabold text-slate-800">Series C ($45M Raised)</span>
                </div>
              </div>

              <div>
                <span className="text-3xs font-bold text-slate-400 uppercase tracking-wider block mb-2">Detected Tech Stack</span>
                <div className="flex flex-wrap gap-1.5">
                  {['React', 'TypeScript', 'PostgreSQL', 'AWS', 'Salesforce', 'HubSpot', 'Snowflake', 'Stripe'].map(tech => (
                    <span key={tech} className="px-2.5 py-1 text-2xs font-extrabold bg-slate-100 text-slate-700 rounded-lg border border-slate-200">
                      {tech}
                    </span>
                  ))}
                </div>
